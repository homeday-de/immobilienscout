...
RSpec.describe Immobilienscout::API::Property, type: :model do
  ...
  before do
    ...
    allow(Immobilienscout).to receive(:configuration)
      .and_return(configuration_double)
  end

  describe '#create' do
    let!(:create_params) do
      { "realestates.apartmentBuy": { externalId: 'extID123',
                                      title: 'RestAPi appartmentBuy',
                                      creationDate: '2014-08-12T15:56:52.000+02:00',
                                      address: { street: 'Andreasstraße', houseNumber: '10', postcode: '10243', city: 'Berlin', wgs84Coordinate: { latitude: 52.51245, longitude: 13.43134 } },
                                      apiSearchData: { searchField1: 'apiSearchField1', searchField2: 'apiSearchField2', searchField3: 'apiSearchField3' },
                                      ...
                                      floor: 2,
                                      lift: 'true',
                                      energyCertificate: { energyCertificateAvailability: 'AVAILABLE', energyCertificateCreationDate: 'BEFORE_01_MAY_2014' },
                                      cellar: 'YES',
                                      ...
                                      energySourcesEnev2014: { energySourceEnev2014: ['WOOD_CHIPS'] },
                                      ...
                                      rentalIncome: 895,
                                      listed: 'YES',
                                      parkingSpacePrice: 15_000,
                                      summerResidencePractical: 'YES',
                                      price: { value: 175_000, currency: 'EUR', marketingType: 'PURCHASE', priceIntervalType: 'ONE_TIME_CHARGE' },
                                      livingSpace: 75,
                                      numberOfRooms: 3,
                                      ...
                                      garden: 'true',
                                      courtage: { hasCourtage: 'YES', courtage: 'Provisionshöhe (brutto)', courtageNote: 'Provisionshinweis (noch 500 Zeichen)' },
                                      serviceCharge: 575 } }
    end
  ...
  describe '#update' do
    ...
    let!(:update_params) do
      { "realestates.apartmentBuy": { :@id => '315676289',
                                      :externalId => update_ext_id,
                                      :title => 'Updated Title',
                                      :address =>
    { street: 'Updated Street',
      ...
      postcode: '26382',
      city: 'Wilhelmshaven',
      wgs84Coordinate: { latitude: 53.5212436, longitude: 8.1049089 },
      geoHierarchy: { continent: { geoCodeId: 1, fullGeoCodeId: '1' },
                      country: { geoCodeId: 276, fullGeoCodeId: '1276' },
                      region: { geoCodeId: 9, fullGeoCodeId: '1276009' },
                      city: { geoCodeId: 44, fullGeoCodeId: '1276009044' },
                      quarter: { geoCodeId: 6, fullGeoCodeId: '1276009044006' },
                      neighbourhood: { geoCodeId: 3_405_000_000_170 } } },
                                      :realEstateState => 'ACTIVE',
                                      :descriptionNote => 'New Description',
                                      :locationNote => 'New Location',
                                      :showAddress => 'false',
                                      :contact => { :@id => '96701088' },
                                      :apartmentType => 'APARTMENT',
                                      :floor => 1,
                                      :lift => 'false',
                                      :energyCertificate => { energyCertificateAvailability: 'AVAILABLE', energyCertificateCreationDate: 'FROM_01_MAY_2014', energyEfficiencyClass: 'G' },
                                      :cellar => 'YES',
                                      ...
                                      :price => { value: 200_000, currency: 'EUR', marketingType: 'PURCHASE', priceIntervalType: 'ONE_TIME_CHARGE' },
                                      :livingSpace => 66.93,
                                      :numberOfRooms => 4,
                                      :energyPerformanceCertificate => 'true',
                                      ...
                                      :balcony => 'false',
                                      :garden => 'false',
                                      :courtage => { hasCourtage: 'YES', courtage: '4,75% vom Kaufpreis inkl. 19% MwSt.' },
                                      :serviceCharge => 132 } }
    end
    ...
    context 'when request is successful' do
      it 'returns updated' do
        ...
        VCR.use_cassette('show_updated_is24', record: :once) do
          ...
          expect(parsed_show_response.messages['realestates.apartmentBuy']['price']['value']).to eq(200_000)
        end
      end
    end
